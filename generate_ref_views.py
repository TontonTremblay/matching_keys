...
torch.save(cam_mtx,f'{opt.outf}/cam_mtx.pt')
torch.save(cam_proj,f'{opt.outf}/cam_proj.pt')
torch.save(result["pos"],f'{opt.outf}/pos.pt')
torch.save(result["pos_idx"],f'{opt.outf}/pos_idx.pt')